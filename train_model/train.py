...
####！！！开始训练！！！####
model_ft, val_acc_history, train_acc_history, valid_losses, train_losses, LRs = utils.train_model(model_ft, scheduler, device, dataloaders, criterion, optimizer_ft, 40, 'best.pt')
#最后保存模型为best.pt